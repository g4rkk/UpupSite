const addChatLike = '/main/bad/chat/like/add';
const removeChatLike = '/main/bad/chat/like/delete';

const addReplyLike = '/main/bad/reply/like/add';
const removeReplyLike = '/main/bad/reply/like/delete';
